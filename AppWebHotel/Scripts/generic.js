    ...
    for (var i = 0; i < res.length; i++) {
        ...
        if (objConfiguracion.editar == true || objConfiguracion.eliminar == true) {
            ...
            if (objConfiguracion.editar == true) {
               ...
               onclick='Editar(${fila[objConfiguracion.propiedadId]})' ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eyedropper" viewBox="0 0 16 16">
            ...
            if (objConfiguracion.eliminar == true) {
                ...
                onclick='Eliminar(${fila[objConfiguracion.propiedadId]})'  ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
        ...
        if (hijosArray.label == undefined) {
            ...
            if (typelemento == "text" || typelemento == "number" || typelemento == "date") {
                ...
                contenido += `<textarea name="${hijosArray.name}"
                                class="form-control"
                                rows="${hijosArray.rows}" cols="${hijosArray.rows}"
